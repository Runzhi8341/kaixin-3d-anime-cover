...
画面：人物在未来感工作台前操作 AI 助手；中文标题醒目、有传播感。
```
...
```text
使用 $kaixin-3d-anime-cover 做 3:4 封面。
主题：[内容主题]
标题：[原始标题]
平台：[小红书 / 抖音 / 视频号]
人物：[附上本次要使用的人物照片 / 不需要人物]
氛围：[热血、轻松、未来感、魔法学院……]
```
...
```text
使用 $kaixin-3d-anime-cover 重做这张封面：保留标题核心信息，
但让画面更像开心的 3D 动漫风格；先给我一个更适合排版的标题备选。
```
...
| `references/` | 画面、排版、人物参考与设计流程指南 |
| `scripts/compose_cover.py` | 稳定生成中文标题排版的工具 |
| `assets/` | 参考封面、人物参考和可用字体资源 |
| `evals/` | 触发与交付质量的回归用例 |
